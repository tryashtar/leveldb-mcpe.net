...
namespace LevelDB {
    ...
    public class WriteBatch : LevelDBHandle {
        ...
        /// <summary>Clear all updates buffered in this batch. </summary>
        public void Clear() {
        ...
        /// <summary>If the database contains a mapping for "key", erase it.  
        ...
        /// <summary>Support for iterating over a batch. </summary>
