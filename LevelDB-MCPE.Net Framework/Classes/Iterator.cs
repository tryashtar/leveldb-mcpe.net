...
namespace LevelDB {
    ...
    public class Iterator : LevelDBHandle {
        ...
        /// <summary>An iterator is either positioned at a key/value pair, or
        /// not valid.   </summary>
        ...
        /// <summary>Position at the first key in the source.  
        /// The iterator is IsValid() after this call iff the source is not empty. </summary>
        public void SeekToFirst() {
            LevelDBInterop.leveldb_iter_seek_to_first(this.Handle);
            this.Throw();
        }

        /// <summary>Position at the last key in the source.  
        /// The iterator is IsValid() after this call iff the source is not empty. </summary>
        ...
        /// <summary>Position at the first key in the source that at or past target
        /// The iterator is IsValid() after this call iff the source contains
        /// an entry that comes at or past target. </summary>
        ...
        /// <summary>Return the key for the current entry.  
        /// REQUIRES: IsValid() </summary>
        ...
        /// <summary>Return the value for the current entry.  
        /// REQUIRES: IsValid() </summary>
        ...
        /// <summary>If an error has occurred, throw it.   </summary>
        private void Throw() {
