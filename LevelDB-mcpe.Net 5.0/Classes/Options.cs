...
namespace LevelDB {
    ...
    public class Options : LevelDBHandle {
        ...
        /// <summary>If true, the database will be created if it is missing. </summary>
        public Boolean CreateIfMissing {
            set => LevelDBInterop.leveldb_options_set_create_if_missing(this.Handle, value ? (Byte)1 : (Byte)0);
        }

        /// <summary>If true, an error is raised if the database already exists. </summary>
        public Boolean ErrorIfExists {
            set => LevelDBInterop.leveldb_options_set_error_if_exists(this.Handle, value ? (Byte)1 : (Byte)0);
        }

        /// <summary>If true, the implementation will do aggressive checking of the
        /// data it is processing and will stop early if it detects any
        /// errors.  This may have unforeseen ramifications: for example, a
        /// corruption of one DB entry may cause a large number of entries to
        /// become unreadable or for the entire DB to become unopenable. </summary>
        public Boolean ParanoidChecks {
            set => LevelDBInterop.leveldb_options_set_paranoid_checks(this.Handle, value ? (Byte)1 : (Byte)0);
        }

        /// <summary>Use the specified Env object to interact with the environment,
        /// e.g. to read/write files, schedule background work, etc. </summary>
        public Env Env {
            get => this.EnvValue;
            set {
        ...
        /// <summary>Amount of data to build up in memory (backed by an unsorted log
        ...
        /// <summary>Number of open files that can be used by the DB.  You may need to
        ...
        /// <summary>Control over blocks (user data is stored in a set of blocks, and
        /// a block is the unit of reading from disk).
        ///
        /// If not set, leveldb will automatically create and use an 8MB internal cache. </summary>
        public Cache Cache {
            get => this.CacheValue;
            set {
        ...
        /// <summary>Approximate size of user data packed per block.  Note that the
        ...
        /// <summary>Number of keys between restart points for deltan encoding of keys.
        ...
        /// <summary>Compress blocks using the specified compression algorithm.  
        /// This parameter can be changed dynamically.
        ///
        ...
        /// efficiently detect that and will switch to uncompressed mode. </summary>
